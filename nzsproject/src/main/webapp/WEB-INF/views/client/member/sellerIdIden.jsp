      ...
      <meta charset="UTF-8" />
         ...
         <meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1">
          ...
          <script type="text/javascript">
          	...
          	$(function(){
          		errorCodeCheck();
          		$("#sellerIdIden").click(function(){
          			if (!formCheck($('#s_name'), $('.error:eq(0)'), "이름을")) return;
	...
	<div class="well">
		<form id="memberForm" class="form-horizontal">
			...
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-3">
					<input type="text" id="s_mailName" name="s_mailName" maxlength="60" class="form-control" placeholder="Email">
				</div>
				<div class="col-sm-2">
			...
			<div class="form-group">	
				<div class="col-sm-offset-2 col-sm-6">
					<input type="button" value="확인" id="sellerIdIden" class="btn btn-default" /> 
