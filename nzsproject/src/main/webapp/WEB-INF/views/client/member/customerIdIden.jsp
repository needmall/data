	...
	<div class="well">
		<form id="memberForm" class="form-horizontal">
			...
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-3">
					<input type="text" id="c_mailName" name="c_mailName" maxlength="60" class="form-control" placeholder="Email">
				</div>
				<div class="col-sm-2">
			...
			<div class="form-group">	
				<div class="col-sm-offset-2 col-sm-6">
					<input type="button" value="확인" id="customerIdIden" class="btn btn-default" /> 
