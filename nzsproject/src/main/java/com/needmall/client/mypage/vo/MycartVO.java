...
public class MycartVO extends ProductdetailVO {
	...
	public String toString() {
		return "MycartVO [cart2_num=" + cart2_num + ", cart1_num=" + cart1_num + ", ps_num=" + ps_num + ", cart2_count="
				...
				+ getP_update() + ", getP_content()=" + getP_content() + ", getP_division()=" + getP_division()
				+ ", getDiscount()=" + getDiscount() + ", getSt_num()=" + getSt_num() + ", getC1_num()=" + getC1_num()
				+ ", getC1_name()=" + getC1_name() + ", getC2_num()=" + getC2_num() + ", getC2_name()=" + getC2_name()
				+ ", getChangeCount()=" + getChangeCount() + ", getPs_regdate()=" + getPs_regdate()
				+ ", getPs_expiration()=" + getPs_expiration() + ", getPs_count()=" + getPs_count() + ", getPs_price()="
